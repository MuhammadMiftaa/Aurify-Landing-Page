    ...
    <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="col-span-full sm:col-span-1">
                    <label for="code" class="fi-fo-field-wrp-label inline-flex items-center gap-x-3">
                        <span class="text-sm font-medium leading-6 text-gray-950 dark:text-white">Code</span>
                    </label>
                    <div class="mt-1">
                        <x-filament::input.wrapper>
                            <x-filament::input type="text" wire:model="code" id="code" disabled />
                        </x-filament::input.wrapper>
                    </div>
                </div>
                ...
                <div class="col-span-full sm:col-span-1">
                    ...
                    <div class="mt-1">
                        <x-filament::input.wrapper>
                            <x-filament::input type="text" wire:model="unit" id="unit" required />
                        </x-filament::input.wrapper>
                        @error('unit')
                            <p class="mt-1 text-sm text-danger-600 dark:text-danger-400">{{ $message }}</p>
                        @enderror
        ...
        <div class="fi-form-actions flex flex-wrap items-center justify-start gap-4">
            ...
            <x-filament::button type="button" color="danger" wire:click="delete"
                wire:confirm="Are you sure you want to delete this asset code?">
                Delete
            </x-filament::button>
        </div>
    </form>
